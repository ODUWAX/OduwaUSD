...
class VersionBitsWarningTest(OduwaUSD_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because oduwausd_coind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
