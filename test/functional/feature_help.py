...
"""Verify that starting oduwausd_coin with -h works as expected."""

from test_framework.test_framework import OduwaUSD_CoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OduwaUSD_CoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oduwausd_coin with -h for help text")
        ...
        self.log.info("Start oduwausd_coin with -version for version information")
        ...
        self.log.info("Start oduwausd_coind with -fakearg to make sure it does not start")
