...
class FullBlockTest(OduwaUSD_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure oduwausd_coind isn't accepting b26
        ...
        # Extend the b28 chain to make sure oduwausd_coind isn't accepting b28
        ...
        # oduwausd_coind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the oduwausd_coin code has custom code which does so);
