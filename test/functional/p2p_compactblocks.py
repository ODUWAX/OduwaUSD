...
# TestP2PConn: A peer we use to send messages to oduwausd_coind, and store responses.
...
class CompactBlocksTest(OduwaUSD_CoinTestFramework):
    ...
    # This test actually causes oduwausd_coind to (reasonably!) disconnect us, so do this last.
    ...
    # oduwausd_coind's choice of nonce.
    ...
    # Test that oduwausd_coind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for oduwausd_coind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # oduwausd_coind will not send blocktxn responses for blocks whose height is
