...
class WalletTest(OduwaUSD_CoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 OWDT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 owdt in block rewards plus fees, but
        ...
        # Send 10 OWDT with subtract fee from amount
        ...
        # Sendmany 10 OWDT with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/oduwausd_coin/oduwausd_coin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
