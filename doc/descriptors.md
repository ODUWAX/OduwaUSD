# Support for Output Descriptors in OduwaUSD Coin

Since OduwaUSD Coin v0.17, there is support for Output Descriptors in the
...
- [WIF](https://en.oduwausd_coin.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
-`xpub` encoded extended public key or `xprv` encoded private key (as defined in [BIP 32](https://github.com/oduwausd_coin/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `3...`, defined in [BIP 13](https://github.com/oduwausd_coin/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `bc1...`, defined in [BIP 173](https://github.com/oduwausd_coin/bips/blob/master/bip-0173.mediawiki)).
...
on OduwaUSD_Coin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing OduwaUSD Coin wallets, a convenience function `combo` is
