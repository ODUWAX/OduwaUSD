OduwaUSD Coin version 0.9.2.1 is now available from:

  https://oduwausd_coin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OWDT to 0.01 OWDT
...
- Fix "Start oduwausd_coin on system login"
