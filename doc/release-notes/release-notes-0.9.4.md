OduwaUSD Coin version 0.9.4 is now available from:

  https://oduwausd_coin.org/bin/0.9.4/
...
this update is incompatible with the OduwaUSD_Coin system and could lead to consensus
forks.

OduwaUSD Coin released binaries from https://oduwausd_coin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~oduwausd_coin/+archive/ubuntu/oduwausd_coin
- A third-party or self-compiled OduwaUSD Coin

upgrade to OduwaUSD Coin 0.9.4, which includes a workaround, **before** updating
OpenSSL.
