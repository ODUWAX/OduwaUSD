OduwaUSD Coin version 0.13.2 is now available from:

  <https://oduwausd_coin.org/bin/oduwausd_coin-core-0.13.2/>
...
- #8908 `4a974b2` Update oduwausd_coin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow oduwausd_coin-tx to create v2 transactions (owdtdrak)
