OduwaUSD_Coin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/oduwausd_coin/files/OduwaUSD_Coin/oduwausd_coin-0.5.4/
...
http://gitorious.org/oduwausd_coin/oduwausd_coind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OduwaUSD_Coin-Qt notifications under Growl 1.3.
Increase required age of OduwaUSD_Coin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOduwaUSD_Coin properly when installing OduwaUSD_Coin-Qt over it. (Windows)
