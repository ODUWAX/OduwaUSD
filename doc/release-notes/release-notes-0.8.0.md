OduwaUSD_Coin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/oduwausd_coin/files/OduwaUSD_Coin/oduwausd_coin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OduwaUSD_Coin
...
New/changed settings (command-line or oduwausd_coin.conf file)
--------------------------------------------------------
