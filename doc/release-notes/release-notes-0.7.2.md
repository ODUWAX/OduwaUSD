OduwaUSD_Coin version 0.7.2 is now available from:
  http://sourceforge.net/projects/oduwausd_coin/files/OduwaUSD_Coin/oduwausd_coin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused OduwaUSD_Coin-Qt to crash on Windows when exiting.
