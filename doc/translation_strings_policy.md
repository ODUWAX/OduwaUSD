...
This document provides guidelines for internationalization of the OduwaUSD Coin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `oduwausd_coin_en.ts` remains unchanged.
