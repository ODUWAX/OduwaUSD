...
#ifndef ODUWAUSD_COIN_WALLET_WALLET_H
#define ODUWAUSD_COIN_WALLET_WALLET_H
...
public:
     ...
     * on this oduwausd_coin node, and set to 0 for transactions that were created
...
#endif // ODUWAUSD_COIN_WALLET_WALLET_H
