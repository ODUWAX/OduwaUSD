 ...
 */
#ifndef ODUWAUSD_COIN_UTIL_H
#define ODUWAUSD_COIN_UTIL_H
...
extern const char * const ODUWAUSD_COIN_CONF_FILENAME;
extern const char * const ODUWAUSD_COIN_PID_FILENAME;
...
{
    std::string s = strprintf("oduwausd_coin-%s", name);
