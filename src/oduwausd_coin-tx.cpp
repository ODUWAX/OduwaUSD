...
static void SetupOduwaUSD_CoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " oduwausd_coin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  oduwausd_coin-tx [options] <hex-tx> [commands]  Update hex-encoded oduwausd_coin transaction\n" +
            "or:     oduwausd_coin-tx [options] -create [commands]   Create hex-encoded oduwausd_coin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oduwausd_coin transaction
