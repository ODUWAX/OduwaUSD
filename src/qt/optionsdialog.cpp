    ...
    mapper(0)
{
    ...
    ui->oduwausd_coinAtStartup->setToolTip(ui->oduwausd_coinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->oduwausd_coinAtStartup->setText(ui->oduwausd_coinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openOduwaUSD_CoinConfButton->setToolTip(ui->openOduwaUSD_CoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new OduwaUSD_CoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->oduwausd_coinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openOduwaUSD_CoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openOduwaUSD_CoinConf())
