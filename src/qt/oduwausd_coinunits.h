...
#ifndef ODUWAUSD_COIN_QT_ODUWAUSD_COINUNITS_H
#define ODUWAUSD_COIN_QT_ODUWAUSD_COINUNITS_H
...
/** OduwaUSD_Coin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OduwaUSD_CoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OduwaUSD_CoinUnits(QObject *parent);

    /** OduwaUSD_Coin units.
      @note Source: https://en.oduwausd_coin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        OWDT,
...
typedef OduwaUSD_CoinUnits::Unit OduwaUSD_CoinUnit;

#endif // ODUWAUSD_COIN_QT_ODUWAUSD_COINUNITS_H
