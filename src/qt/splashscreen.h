...
#ifndef ODUWAUSD_COIN_QT_SPLASHSCREEN_H
#define ODUWAUSD_COIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. OduwaUSD Coin initialization
...
#endif // ODUWAUSD_COIN_QT_SPLASHSCREEN_H
