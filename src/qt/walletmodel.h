...
#ifndef ODUWAUSD_COIN_QT_WALLETMODEL_H
#define ODUWAUSD_COIN_QT_WALLETMODEL_H
...
/** Interface to OduwaUSD_Coin wallet from Qt view code. */
...
#endif // ODUWAUSD_COIN_QT_WALLETMODEL_H
