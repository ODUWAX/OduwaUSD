...
#ifndef ODUWAUSD_COIN_QT_SENDCOINSDIALOG_H
#define ODUWAUSD_COIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending oduwausd_coins */
...
#endif // ODUWAUSD_COIN_QT_SENDCOINSDIALOG_H
