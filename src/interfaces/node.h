...
#ifndef ODUWAUSD_COIN_INTERFACES_NODE_H
#define ODUWAUSD_COIN_INTERFACES_NODE_H
...
//! Top-level interface for a oduwausd_coin node (oduwausd_coind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ODUWAUSD_COIN_INTERFACES_NODE_H
