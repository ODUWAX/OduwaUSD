...
#ifndef ODUWAUSD_COIN_TEST_SCRIPTNUM10_H
#define ODUWAUSD_COIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from OduwaUSD Coin 0.10.0, for cross-comparison.
 */
public:
...
#endif // ODUWAUSD_COIN_TEST_BIGNUM_H
