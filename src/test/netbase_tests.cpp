...
{
    BOOST_CHECK(TestSplitHost("www.oduwausd_coincore.org", "www.oduwausd_coincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.oduwausd_coincore.org]", "www.oduwausd_coincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.oduwausd_coincore.org:80", "www.oduwausd_coincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.oduwausd_coincore.org]:80", "www.oduwausd_coincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2520", "127.0.0.1", 2520));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2520", "127.0.0.1", 2520));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2520", "::ffff:127.0.0.1", 2520));
    BOOST_CHECK(TestSplitHost("[::]:2520", "::", 2520));
    BOOST_CHECK(TestSplitHost("::2520", "::2520", -1));
    BOOST_CHECK(TestSplitHost(":2520", "", 2520));
    BOOST_CHECK(TestSplitHost("[]:2520", "", 2520));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2520", "127.0.0.1:2520"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2520", "[::]:2520"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
